...
number is
1
, and the nth number is the sum of the (n - 1)th and (n - 2)th numbers. Write a function that
...
F1 = 1 . For the purpose of this question, the first Fibonacci number is
FO
; therefore,
